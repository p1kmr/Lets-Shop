<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="WebApplication2.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server" Page EnableEventValidation="true">
    ...
    <div class="col-sm-8">
      ...
      <%--<button  id="btn11" runat="server" onclick="btn11_onclick()">Get in Touch</button>--%>
        <asp:Button  class="btn btn-default btn-lg" ID="Button1" runat="server" 
            Text="Get in Touch" onclick="Button1_Click1" />
...
<footer class="container-fluid text-center">
  ...
  <p> Made By <a  href="#" title="Visit w3schools">Let's Shop</a></p>
</footer>
