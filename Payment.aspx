...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row" style="padding-top: 20px;">
       ...
       <div class="form-group">
                    ...
                    <asp:TextBox ID="txtName" CssClass="form-control" runat="server" OnTextChanged="txtName_TextChanged"></asp:TextBox>
            ...
            <div class="form-group">
                    ...
                    <asp:TextBox ID="txtAddress" TextMode="MultiLine" CssClass="form-control" runat="server" OnTextChanged="txtAddress_TextChanged"></asp:TextBox>
