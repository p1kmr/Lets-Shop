       ...
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
             ...
             <div class ="form-group">
               <asp:Label ID="Label19" runat="server" CssClass ="col-md-2 control-label" Text="Upload Image"></asp:Label>
               <div class ="col-md-3">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <asp:Button ID="btnAdd" CssClass="btn btn-success " runat="server" Text="ADD Product &raquo;" OnClick="btnAdd_Click" style="height: 29px" />
